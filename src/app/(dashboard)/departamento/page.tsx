    ...
    <div className="w-full h-full p-8 flex flex-col bg-gray-50 dark:bg-gray-900">
      ...
      <div className="grid grid-cols-1 items-center mt-6 gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card
          ...
          icon={
            <LuBuilding2 size={28} className="text-white dark:text-blue-300" />
          }
          description="3"
        ...
        <Card
          ...
          icon={
            <LuCircleCheckBig
              size={28}
              className="text-white dark:text-emerald-300"
            />
          }
          description="3"
        ...
        <Card
          ...
          icon={
            <LuUsers size={28} className="text-white dark:text-purple-300" />
          }
          description="3"
        ...
        <Card
          ...
          icon={
            <LuBuilding2
              size={28}
              className="text-white dark:text-orange-300"
            />
          }
          description="S/. 6500"
