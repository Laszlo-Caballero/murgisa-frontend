    ...
    <div className="w-full p-8 flex flex-col">
      ...
      <header className="flex items-center justify-between gap-x-4">
        <div className="flex items-center gap-x-4">
          <span className="bg-pink-600 p-3 rounded-lg">
            <LuClipboardList size={40} className="text-white" />
          </span>
          <div className="flex flex-col">
        ...
        <Button
          className="flex items-center gap-x-3 py-3 font-semibold bg-pink-600 hover:bg-pink-500"
          onClick={() => {
            setShowModal(true);
          }}
        >
