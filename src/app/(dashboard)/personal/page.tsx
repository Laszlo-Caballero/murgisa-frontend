        ...
        <div className="flex flex-col items-center justify-center w-full max-w-3/4 p-4">
            ...
            <div className="relative w-full  border border-slate-40 mt-4">
                ...
                <div className="flex items-center gap-x-25">
                    ...
                    <option value="cargo1">Ciudad 1</option>
                    <option value="cargo2">Ciudad 2</option>
                    <option value="cargo3">Ciudad 3</option>
                    </Select>
                    <Select id="txtProfesion" label="Profesion:" className="flex-row gap-x-2">
                    <option value="profesion1">Ciudad 1</option>
                    <option value="profesion2">Ciudad 2</option>
                    <option value="profesion3">Ciudad 3</option>
                    </Select>
                </div>
        
                <div className="flex items-center gap-x-25">
                    <Select id="txtDepartamento" label="Departamento:" className="flex-row gap-x-2">
                    <option value="departamento1">Ciudad 1</option>
                    <option value="departamento2">Ciudad 2</option>
                    <option value="departamento3">Ciudad 3</option>
                    </Select>
                    <Input
                    id="chkEstado"
                    label="Estado"
